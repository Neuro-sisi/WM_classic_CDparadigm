...
for trial = 1:TrialNum
    ...
    elseif mod(trial,break_after) == 1 && trial > 1
        ...
        save (fullfile (['Temp_UnlaterCD368_sub' num2str(SubNum)  '_Block' num2str(BlockNum) '_miniblock' num2str((trial-1)/break_after) 'cf.mat']));
...
save (fullfile (['UnlaterCD368_sub' SubNum  '_' num2str(BlockNum) '_cf.mat']));
Screen('CloseAll');
