...
for trial = 1:TrialNum
    ...
    elseif mod(trial,break_after) == 1 && trial > 1
        ...
        save (fullfile (['Temp_Prac_UnlaterCD368_sub' num2str(SubNum)  '_Block' num2str(BlockNum) '_miniblock' num2str((trial-1)/break_after) 'cj.mat']));
...
save (fullfile (['Prac_UnlaterCD368_sub' SubNum  '_' num2str(BlockNum) '_cj.mat']));
Screen('CloseAll');
